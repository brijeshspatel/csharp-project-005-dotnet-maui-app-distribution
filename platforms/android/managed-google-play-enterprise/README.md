...
⚠️ **Do not use it for an app you may later want to publish publicly.** See the warning in §12 —
...
⚠️ **WARNING — restricting an app to organisations is not reversible for that package name.** Once
