...
| Build tooling floor | Xcode 26 with an iOS 26 SDK, required for anything **uploaded** to App Store Connect from 2026-04-28 | API level 36 from 2026-08-31, API 35 until then, with an extension to 2026-11-01 available on request; the floor rises annually |
