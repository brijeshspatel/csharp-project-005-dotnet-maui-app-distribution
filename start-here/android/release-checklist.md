...
| 3 | Prerequisites | [Confirm the target API level](../../platforms/android/google-play-public-release/README.md#5-prerequisites): **API 36 from 2026-08-31**, and the floor rises annually | — | Target matches Google's current floor | Check the floor before building; it moves annually | ☐ |
